      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="https://www.facebook.com/share/195ch9DabE/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 ${isRTL ? 'space-x-reverse' : ''} text-muted-foreground hover:text-primary transition-colors`}><Facebook className="w-5 h-5" /><span>Facebook</span></a></li>
              <li><a href="https://www.instagram.com/loudstyless?igsh=MTE4bnlzM2dyYXB2YQ==" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 ${isRTL ? 'space-x-reverse' : ''} text-muted-foreground hover:text-primary transition-colors`}><Instagram className="w-5 h-5" /><span>LOUD Styles</span></a></li>
              <li><a href="https://www.instagram.com/loudim_brand?igsh=OXdzMGttejQzOWoy" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 ${isRTL ? 'space-x-reverse' : ''} text-muted-foreground hover:text-primary transition-colors`}><Instagram className="w-5 h-5" /><span>LOUDIM</span></a></li>
              <li><a href="https://www.tiktok.com/@loudstyles?_t=ZS-8zI7QXNey0L&_r=1" target="_blank" rel="noopener noreferrer" className={`flex items-center space-x-3 ${isRTL ? 'space-x-reverse' : ''} text-muted-foreground hover:text-primary transition-colors`}><svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg><span>TikTok</span></a></li>
            </ul>
          </div>
        </div>
