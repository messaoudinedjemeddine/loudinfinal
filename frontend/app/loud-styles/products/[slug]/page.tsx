...
export default function LoudStylesProductPage() {
  ...
  useEffect(() => {
    ...
    async function fetchProduct() {
      try {
        setLoading(true)
        const response = await fetch(`/api/products/slug/${slug}?brand=loud-styles`)
      ...
      <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          >
            ...
            <span>/</span>
            <Link href="/loud-styles" className="hover:text-foreground transition-colors">
              LOUD STYLES
            </Link>
            <span>/</span>
            <Link href="/loud-styles/products" className="hover:text-foreground transition-colors">
