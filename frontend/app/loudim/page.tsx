...
export default function LoudimHomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-warm-50 to-cream-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="container mx-auto px-4">
          <div className={`flex items-center justify-between h-16 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            <div className="flex-shrink-0">
              <Link href="/loudim" className="flex items-center group">
                  ...
                  <h1 className="text-xl md:text-2xl tracking-wider cursor-pointer">
                    <span className="inline-block">
                      ...
                      <span className="relative inline-block ml-2">
                        <span className="text-gray-700 dark:text-gray-300 transition-colors duration-300 group-hover:text-primary font-light">IM</span>
                      </span>
                    </span>
                  </h1>
                </div>
            ...
            <div className="max-w-6xl mx-auto relative">
              ...
              >
                {categories.map((category, index) => (
                  ...
                  >
                    <Link href={`/loudim/products?category=${category.slug}`}>
                ...
                {featuredProducts.slice(0, 4).map((product, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="h-full"
                    >
                      <Link href={`/loudim/products/${product.slug}`} className="block h-full">
      ...
      {/* Newsletter Section */}
      <section className="py-20 text-white" style={{ backgroundColor: '#a58a66' }}>
          ...
          >
            ...
            <div className={`flex flex-col sm:flex-row gap-4 max-w-md mx-auto ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
              <input
                ...
                dir={isRTL ? 'rtl' : 'ltr'}
              />
              <Button variant="secondary" size="lg" className="bg-white hover:bg-gray-100 font-medium" style={{ color: '#a58a66' }}>
